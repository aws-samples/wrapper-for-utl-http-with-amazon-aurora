CREATE OR REPLACE FUNCTION utl_http_utility.write_text(
...
BEGIN   
	...
	then
		...
		l_text := CONCAT_WS('', json_extract_path_text(l_req.payload,'body'), data, CHR(13), CHR(10));
...
EXCEPTION
    WHEN others THEN
        RAISE NOTICE 'In exception of utl_http_utility.write_text: %', sqlerrm;
END;
$BODY$;